  ...
  return (
    <div className='mx-auto w-full max-w-xl relative rounded-4xl border border-slate-200/80 bg-white shadow-xl shadow-slate-300/50 px-8 py-4 sm:px-10'>
      ...
      <div className='mb-4 text-center'>
        <p className='text-xs uppercase tracking-[0.35em] text-slate-500'>Captain Login</p>
        <h1 className='mt-1.5 text-3xl font-semibold tracking-tight text-slate-900 sm:text-4xl'>Welcome back</h1>
        <p className='mt-1 text-sm leading-6 text-slate-600'>Log in to continue to your Drive.</p>
      </div>
      ...
      <form
        ...
        <div className='space-y-3'>
          <label htmlFor='email' className='block text-sm font-medium text-slate-700'>What's our Captain's Email?</label>
          <input
            id='email'
            type='email'
            value={Email}
        ...
        <div className='space-y-1'>
          <label htmlFor='password' className='block text-sm font-medium text-slate-700'>What's our Captain's Password</label>
      ...
      <div className='mt-6 text-center text-sm text-slate-500'>
        New here? <Link to={'/captains/register'} className='font-medium text-slate-900 hover:text-slate-700 hover:underline'>Register as Captain</Link>
      </div>
    </div>
  )
}
